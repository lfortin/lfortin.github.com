...
`),render(){let e=this.template({post:this.currentPost?this.currentPost.toJSON():null});return this.$el.html(e),this}}),_=[{id:`cc895078-2ab0-45e8-b346-2a4d025647c0`,title:`os-monitor`,description:`A very simple monitor for Node.js that allows you to observe some OS parameters, such as free memory available, load average or free disk space.`,link:`/os-monitor`},{id:`eae3cb6c-d6fb-4007-8afd-7d2e32c5b759`,title:`cgi-core`,description:`A lightweight, zero-dependency middleware for hosting CGI scripts with HTTP/1.1 support.`,link:`/cgi-core`},{id:`5916615a-0fca-4854-bfc4-c1ffdbea9337`,title:`react-floorlamp`,description:`Straightforward state management for React.`,link:`https://npmx.dev/package/react-floorlamp`},{id:`177aa50c-a466-4c56-987c-c3c794e4fb8d`,title:`vite-backbone`,description:`A starter template for building Backbone.js applications with Vite.`,link:`https://github.com/lfortin/vite-backbone#readme`},{id:`fabe99de-cc77-4d37-9e97-decc3e73fa15`,title:`mock-os`,description:`Testing module for the os built-in module in Node.js.`,link:`https://npmx.dev/package/mock-os`},{id:`03b7a643-52db-4daa-a5b0-f276782cfcca`,title:`jquery-drive`,description:`A jQuery plugin to construct the DOM using basic jQuery selectors. (deprecated)`,link:`https://npmx.dev/package/jquery-drive`},{id:`77ed2189-0949-45cd-9746-3ad82b1df137`,title:`stream-tk`,description:`Experimental toolkit for handling Node.js data streams.`,link:`https://npmx.dev/package/stream-tk`}],v=[{name:`Node.js`,description:`Server-side JavaScript and tooling.`,icon:`bi bi-hexagon-fill`},{name:`TypeScript`,description:`Typed JavaScript and tooling.`,icon:`bi bi-file-earmark`},{name:`Version control ( Git / GitHub )`,description:`Source control and collaboration.`,icon:`bi bi-git`},{name:`Unit testing ( Jest, Vitest )`,description:`Unit and component testing.`,icon:`bi bi-check2-square`},{name:`Databases ( MySQL, PostgreSQL, DynamoDB )`,description:`Relational and NoSQL data modeling.`,icon:`bi bi-database`},{name:`RESTful APIs testing ( Postman )`,description:`API design and testing.`,icon:`bi bi-plug`},{name:`E2E testing ( Cypress, Vitest )`,description:`End-to-end and browser testing.`,icon:`bi bi-browser-chrome`},{name:`Code quality ( ESLint, Oxlint )`,description:`Linting and code standards.`,icon:`bi bi-code-slash`},{name:`AWS ( Lambda, API Gateway, etc. )`,description:`Cloud services and serverless.`,icon:`bi bi-cloud`},{name:`AI-driven tools ( Cursor, etc. )`,description:`AI-assisted development.`,icon:`bi bi-robot`},{name:`Project management tools ( Jira, Confluence )`,description:`Agile and documentation.`,icon:`bi bi-kanban`},{name:`Front-end development ( Backbone.js, React, Vue.js, Angular, etc. )`,description:`SPAs and modern UI frameworks.`,icon:`bi bi-window-stack`},{name:`Build tooling ( Vite )`,description:`Build tooling and dev experience.`,icon:`bi bi-lightning-charge`}],y=[{slug:`2026-03-03-first-blog-post`,date:`2026-03-03`,title:`Hello, World! Welcome to My Portfolio`,excerpt:`A quick hello and a look at what to expect from this blog.`,content:`
    <p>
