...
`,o=Backbone.View.extend({id:`home`,tagName:`div`,events:{"click a.button-counter":`onCounterClick`},onCounterClick(e){e.stopPropagation(),e.preventDefault();let t=$(e.target).closest(`.card`).attr(`data-model-id`),n=this.collection.get(t);n.set(`counter`,n.get(`counter`)+1)},initialize(){this.collection=new r,this.listenTo(this.collection,`update reset change`,this.render)},template:Handlebars.compile(a),render(){let e=this.template({usecases:this.collection.toJSON()});return this.$el.html(e),this}}),s=i`
  <div class="container mt-4">
    <h2>About</h2>
    <p>This is a Vite + Backbone starter template using Bootstrap, Handlebars, and more.</p>
    <p>Released under the MIT-0 License.</p>
  </div>
`,c=Backbone.View.extend({id:`about`,tagName:`div`,render(){return this.$el.html(s),this}}),l=i`
  <div class="container mt-4">
    <h2>Help</h2>
    <p>
...
`,u=Backbone.View.extend({id:`help`,tagName:`div`,render(){return this.$el.html(l),this}}),d=i`
  <div class="container mt-4">
    <h2 class="text-danger"><i class="bi bi-exclamation-triangle"></i> 404 Not Found</h2>
    <p>The page you requested could not be found.</p>
  </div>
`,f=Backbone.View.extend({id:`not-found`,tagName:`div`,render(){return this.$el.html(d),this}}),p=t.extend({idAttribute:`slug`,defaults:{slug:``,title:``,date:``,excerpt:``,content:``,tags:[]}}),m=e.extend({model:p}),h=5,g=i`
...
`,b=Backbone.View.extend({id:`blog-post`,tagName:`div`,initialize(){this.model=new p,this.listenTo(this.model,`change`,this.render)},template:Handlebars.compile(y),render(){let e=this.template({post:this.model?this.model.toJSON():null});return this.$el.html(e),this}}),x=[{id:`cc895078-2ab0-45e8-b346-2a4d025647c0`,title:`Minimal View Convention`,description:`Backbone lets you structure your app into small reusable views.`,link:`https://backbonejs.org/#View`},{id:`eae3cb6c-d6fb-4007-8afd-7d2e32c5b759`,title:`Logic + Layout Separation`,description:`Handlebars templating keeps your HTML clean and logic-free.`,link:`https://handlebarsjs.com/guide/`},{id:`5916615a-0fca-4854-bfc4-c1ffdbea9337`,title:`Quick Styling`,description:`Bootstrap helps rapidly layout components with minimal CSS.`,link:`https://getbootstrap.com/docs/5.3/getting-started/introduction/`},{id:`177aa50c-a466-4c56-987c-c3c794e4fb8d`,title:`Data Binding & Events`,description:`Backbone’s models and collections support change events and syncing with RESTful APIs.`,link:`https://backbonejs.org/#Model`},{id:`fabe99de-cc77-4d37-9e97-decc3e73fa15`,title:`Client-Side Routing`,description:`Use Backbone.Router to manage application state and navigation.`,link:`https://backbonejs.org/#Router`},{id:`03b7a643-52db-4daa-a5b0-f276782cfcca`,title:`Unit Testing`,description:`Vitest is a fast, powerful, and easy-to-use JavaScript test runner.`,link:`https://vitest.dev/guide/`},{id:`77ed2189-0949-45cd-9746-3ad82b1df137`,title:`Fast Dev with Vite`,description:`Vite enables blazing fast HMR and optimized production builds.`,link:`https://vite.dev/guide/`},{id:`dd6eaa1e-f0dc-4f9c-87cc-3f9423a901e6`,title:`Oxlint for Code Quality`,description:`Oxlint statically analyzes your code to find problems and enforce style.`,link:`https://oxc.rs/docs/guide/usage/linter.html`},{id:`b975384c-6294-4d51-a87d-b5092078ad2f`,title:`Single Page App Foundation`,description:`Backbone is ideal for small to medium SPAs with clear structure.`,hasCounter:!0}],S=[{slug:`2026-02-28-getting-started-with-vite-backbone`,date:`2026-02-28`,title:`Getting Started with Vite + Backbone`,excerpt:`Learn how this starter template wires together Vite, Backbone, Handlebars, jQuery, and Bootstrap to build small SPAs.`,content:`
      <p>
